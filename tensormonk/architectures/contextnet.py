...
from ..layers import Convolution, ContextNet_Bottleneck
...
class ContextNet(torch.nn.Module):
    ...
    def __init__(self, tensor_size=(1, 3, 1024, 2048), *args, **kwargs):
        ...
        # 1, 1, 128, 256
        _tensor_size = tuple(F.avg_pool2d(torch.randn(1, *tensor_size[1:]),
                                          5, 4, 2).shape)
        self.DeepNET.add_module("dn_cnv1", Convolution(_tensor_size, 3, 32, 2,
        ...
        # 1, 1, 32, 64
        self.DeepNET.add_module("upsample",
...
# from tensormonk.layers import Convolution, ContextNet_Bottleneck
