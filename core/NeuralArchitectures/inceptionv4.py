...
import torch
from ..NeuralLayers import Stem2, InceptionA, ReductionA, InceptionB, \
...
class InceptionV4(torch.nn.Sequential):
    ...
    def __init__(self,
        ...
        kwargs = {"activation": activation, "normalization": normalization,
                  ...
                  "equalized": equalized, "shift": shift}
...
# from core.NeuralLayers import Stem2, InceptionA, ReductionA, InceptionB, \
#     ReductionB, InceptionC, Linear
