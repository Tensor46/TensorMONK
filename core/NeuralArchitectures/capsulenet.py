...
from ..NeuralLayers import Convolution, ResidualComplex, PrimaryCapsule, \
    RoutingCapsule
...
class CapsuleNet(nn.Module):
    ...
    def __init__(self,
        ...
        if replicate_paper:
            ...
            block = Convolution
            kwargs = {"activation": "relu", "dropout": 0.,
    ...
    def forward(self, tensor, targets):
        ...
        features = self.Routing(tensor_primary)
