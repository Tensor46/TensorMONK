...
class PrimaryCapsule(nn.Module):
    ...
    def __init__(self, tensor_size, filter_size, out_channels, strides=(1, 1), pad=True,
                 activation="relu", dropout=0., batch_nm=False, pre_nm=False, groups=1, weight_norm=False,
        ...
        self.primaryCapsules = block(tensor_size, filter_size, out_channels, strides, pad,
                                     activation, dropout, batch_nm, pre_nm, groups, weight_norm, growth_rate=growth_rate)
