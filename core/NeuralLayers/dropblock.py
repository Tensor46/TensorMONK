""" TensorMONK's :: NeuralLayers :: DropBlock """
...
class DropBlock(nn.Module):
    r"""Sets block_size x block_size of input tensor to zero with a probability
    of p. Implemented - https://arxiv.org/abs/1810.12890
...
# test = DropBlock((1, 3, 10, 10), 0.2, 5, True)
