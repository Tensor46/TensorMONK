""" Training CapsuleNet :: Dynamic Routing Between Capsule Network """
...
def train():
    ...
    Model = MakeModel(file_name,
                      tensor_size,
                      n_labels,
                      embedding_net=tensormonk.architectures.CapsuleNet,
                      embedding_net_kwargs={"replicate_paper": True},
                      loss_net=tensormonk.loss.CapsuleLoss,
                      loss_net_kwargs={},
